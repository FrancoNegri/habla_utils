...
\begin{center}$
\begin{array}{lll}
\includegraphics[trim={0 0 0 1.25cm},clip,width=.5\textwidth]{imagenes/plots_normalized/3.png}
\includegraphics[trim={0 0 0 1.25cm},clip,width=.5\textwidth]{imagenes/plots_normalized/4.png}
\end{array}$
\end{center}
\caption{Oraciones 3 y 4 Normalizadas}
\label{oracionCuatro}
\end{figure}
